...
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--input", type=str, default='/home/nms/people-counting/videos/sample1.mp4',
	help="path to optional output video file")
args = vars(ap.parse_args())
...
while True:
	...
	#grab,frame = vs.read()
	frame = cv2.imread('yolo/dog.jpg') #if args.get("input", False) else frame
	...
	if totalFrames % skip_frames == 0:
		...
		for i in np.arange(0, detections.shape[2]):
			...
			if confidence > 0.5:
				...
				cv2.putText(frame, CLASSES[idx], (startX, startY),
